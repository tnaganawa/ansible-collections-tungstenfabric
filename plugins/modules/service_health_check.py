...
DOCUMENTATION = '''
---
module: service_health_check

short_description: create tungstenfabirc service-health-check

version_added: "2.9"

description:
    - "create / delete tungstenfabric service-health-check"
